...
internal class Client
{
    ...
    /// </summary>
    public static Process Self = Process.GetCurrentProcess();

    internal static bool IsRunning => !Self.HasExited;

    /// <summary>
    /// Get the size of the games main module, in bytes.
    /// </summary>
    internal static int Size
        => Self?.MainModule?.ModuleMemorySize ?? 0;

    /// <summary>
    /// Get the games 'file private part'.
    /// </summary>
    internal static int Build
        => Self.MainModule?.FileVersionInfo.FilePrivatePart ?? 0;

    /// <summary>
    /// Get the games 'file major part'.
    /// </summary>
    internal static int Expansion
        => Self.MainModule?.FileVersionInfo.FileMajorPart ?? 0;

    /// <summary>
    /// Get the base address of the games main module.
    /// </summary>
    internal static IntPtr Address
        => Self.MainModule?.BaseAddress ?? IntPtr.Zero;
